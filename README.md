...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dqraghk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dqraghk.containers.anotherwebservice.com/
...
```
git clone git@github.com:NettixDev/container-dqraghk.git
cd container-dqraghk
```
...
```
docker attach container-dqraghk
```
